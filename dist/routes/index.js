...
const index_2 = __importDefault(require("../controllers/employees/index"));
const ISPs_1 = __importDefault(require("../controllers/ISPs"));
const index_3 = __importDefault(require("../controllers/request/index"));
const index_4 = __importDefault(require("../controllers/response/index"));
function registerApiRoutes(app, prefix = "") {
    app.use(`${prefix}/auth`, new index_1.default().router);
    app.use(`${prefix}/request`, new index_3.default().router);
    app.use(`${prefix}/response`, new index_4.default().router);
    app.use(`${prefix}/isp`, new ISPs_1.default().router);
    app.use(`${prefix}/employee`, new index_2.default().router);
